...
Node 			- hhttps://nodejs.org/en/download/
...
ID 			: 	Disabled input that autogenerates an ID
Customer	:	Allows only numbers
Amount 	 	:	Allows only numbers
Time 	 	:	Disabled input that autogenerates the current UTC time
